...
class Main(Frame):
    ...
    def startUI(self):
        btn = Button(root, text="Камень", bg="black", fg="green",font=("Times New Roman", 15),
                     command=lambda x=1: self.btn_click(x))
        btn2 = Button(root, text="Ножницы",bg="black", fg="green", font=("Times New Roman", 15),
                      command=lambda x=2: self.btn_click(x))
        btn3 = Button(root, text="Бумага", bg="black", fg="green",font=("Times New Roman", 15),
        ...
        self.lbl = Label(root, text="Начало игры!", bg="black", fg="green",font=("Times New Roman", 21, "bold"))
